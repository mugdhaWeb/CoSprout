                    ...
                    <div>
                        <div className="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                            ...
                            <motion.div
                                ...
                                className="text-4xl font-bold text-block sm:text-6xl lg:text-7xl"
                            >
                                your full
                            </motion.div>
                        ...
                        <p className="mt-8 text-base text-black sm:text-xl">
                            Join a network of students, young individuals, and
                            mentors from diverse backgrounds seeking to make a
                            difference in themselves and in the world.
                        </p>
                        ...
                        <div className="mt-10 sm:flex sm:items-center sm:space-x-15">
                            <a
                                href="/apply"
                                title=""
                                className="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 rounded-md bg-teal-600 hover:bg-teal-700 focus:bg-teal-700"
                                role="button"
                            >
                                Apply Now
                            </a>
